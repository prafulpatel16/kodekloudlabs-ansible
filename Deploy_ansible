...
Log in to the Control Host server using ssh, Controlhost_user, and the provided Public IP address and password:

ssh controlhost_user@<Public IP>
...
we need to create the ansible user on both the control host and workstation host.
